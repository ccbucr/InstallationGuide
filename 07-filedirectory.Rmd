...
```{r case, echo = F, auto_pdf = TRUE, fig.align = 'center', out.width= "50%", fig.cap= "Types of font cases (L to R, clockwise): Screaming Snake Case, Camel Case, Upper Camel, Snake Case, Kebab Case. Art Credit: Dr. Allison Horst, UCSB"}
