...
i = 1
s = paste0('title: "Center for Conservation Biology | UC Riverside Adminstration Guide (', c('Bootstrap', 'Tufte'), ' Style)"')
for (fmt in c('html_book', 'tufte_html_book')) {
  ...
  i = i + 1
  bookdown::publish_book(paste0('AdminstrationGuide', i))
}
unlink('_book', recursive = TRUE)
...
bookdown::publish_book('AdminstrationGuide')
