...
```{r arcgisonline, echo = F, auto_pdf = TRUE, fig.align = 'center', fig.height = 4, fig.alt="Screen shot of UCR ArcGIS Online sign in page."}
...
```{r ucrenterprise, echo = F, auto_pdf = TRUE, fig.align = 'center', fig.height = 3, fig.alt="Screen shot of UCR ArcGIS Online Enterprise Account sign in page."}
...
```{r ucrid, echo = F, auto_pdf = TRUE, fig.align = 'center', fig.height = 3, fig.alt="Screen shot of UCR Net ID and Password sign in prompt."}
...
```{r esrisignin, echo = F, auto_pdf = TRUE, fig.align = 'center', fig.height = 4, fig.alt="Screen shot of UCR ArcGIS Online sign in page."}
...
```{r esripro, echo = F, auto_pdf = TRUE, fig.align = 'center', fig.height = 4, fig.alt="Screen shot of UCR ArcGIS Online and Pro account license options and ArcGIS Pro download button."}
