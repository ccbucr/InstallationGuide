...
\hypertarget{slack-apps}{%
\subsubsection{Slack Apps}\label{slack-apps}}
...
\begin{itemize}
\item
  Step 1: Navigate to the \href{https://ucrsupport.service-now.com/ucr_portal}{UCR Portal ServiceLink Software Catalog}.
\item
  Step 2: Under the Information Technology section, select \textbf{Request Services \& Software} link.
\end{itemize}
...
\tightlist
\item
  Step 3: Scroll down to the \textbf{Software Request} card and select link.
\end{itemize}
...
\tightlist
\item
  Step 4: Complete the Software Request form using your UCR NetId and UCR email, then select \textbf{Submit}.
\end{itemize}
