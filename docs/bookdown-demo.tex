...
{\centering \includegraphics{images/bookdown_here} 
...
\begin{flushleft}\includegraphics{images/git_root} \end{flushleft}
...
\begin{flushleft}\includegraphics{images/git_usernote} \end{flushleft}
...
{\centering \includegraphics[width=0.5\linewidth]{images/case_horst} 
